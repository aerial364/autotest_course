...
def move_zeros(lst):
    ...
    count = 0  # Переменная для подсчёта удалённых нулей

    while 0 in lst:  # Пока есть нули в списке
        lst.remove(0)  # Удаляем первый найденный 0
        count += 1  # Увеличиваем счётчик удалённых нулей на 1

    # Добавим к конец списка столько нулей, сколько удалили
