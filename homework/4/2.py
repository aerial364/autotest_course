...
def flatten_and_sort(array):
    result_list = []  # Создаём пустой список, в который будем записывать элементы на одном уровне
    for list in array:  # Для каждого списка в данном массиве
            for item in list:  # Для каждого элемента в списке
                    result_list.append(item)  # Добавим этот элемент в новый список
    result_list.sort()  # Отсортируем элементы в порядке возрастания
    return result_list
