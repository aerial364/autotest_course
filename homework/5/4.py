...
def scrabble(word):
    ...
    # Запишем очки за буквы в словарь в формате = 'буква': кол-во очков
    points_dict = {'а': 1, 'в': 1, 'е': 1, 'ё': 1, 'и': 1, 'н': 1, 'о': 1, 'р': 1, 'с': 1, 'т': 1,
              ...
              'щ': 10,
              'ъ': 15}
    points = 0  # Переменная для подсчёта очков
    for i in word:  # Для каждой буквы в данном слове
        #  Добавим к переменной кол-во очков (Value) найденной буквы по Key = i
        points += points_dict.__getitem__(i)
